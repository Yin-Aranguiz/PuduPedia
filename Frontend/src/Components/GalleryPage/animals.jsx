export const animals = {
    ...
    ranaMaule: {
        ...
        info: [
            { title: "- Vive en", content: "Bosques húmedos y cercanías de ríos en el centro-sur de Chile" },
            ...
            { title: "- Peligro de la especie", content: "Vulnerable debido a la pérdida de hábitat y la contaminación del agua" }
        ]
    },
    ...
    zorroCulpeo: {
        ...
        info: [
            { title: "- Vive en", content: "Diversos hábitats en la región andina y zonas áridas del norte de Chile" },
            { title: "- Reproducción", content: "La hembra da a luz a una camada de crías después de un período de gestación de aproximadamente 60-70 días" },
    ...
    huemul: {
        ...
        info: [
            { title: "- Vive en", content: "Bosques de la Cordillera de los Andes, desde la Región de Los Lagos hasta la Región de Aysén" },
