...
const ProfilePage = () => {
    ...
    const handleFormSubmit = async (formData) => {
      try {
        let url;
        if (formType === 'animal') url = '/user/animals_seen';
        else if (formType === 'plant') url = '/user/plants_seen';
        else if (formType === 'park') url = '/user/parks_visited';
    ...
    return (
      ...
      <div className='sideTabFaves'>
        ...
        <Link to="/user/faves" className='linkToPages'>« Volver a Favoritos</Link>
