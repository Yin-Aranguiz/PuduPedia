...
import TriviaGame from './Components/GamePage/TriviaGame/TriviaGame';
import NavBar from './Components/LandingPage/Navbar/NavBar';
import ParkPage from './Components/ParksPage/ParkPage';
import Notices from './Components/NoticesPage/ApiRequest'; // Importa el componente Notices
import SignAndLog from './Components/LoginPage/SignLog';
    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/image/:id" element={<TriviaGame />} />
                {/* <Route path="/api" element={<MapsApi />} /> Ruta para el mapa */}
                <Route path="/parques" element={<ParkPage />} />
                <Route path="/noticias" element={<Notices />} /> {/* Ruta para el componente Notices */}
                <Route path='/signlog' element={<SignAndLog/>} />
            </Routes>
        </Router>
    );
}
